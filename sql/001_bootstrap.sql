...
CREATE DATABASE IF NOT EXISTS unsay;
...
-- ---------------------------------------------------------------------------
ALTER DATABASE unsay SET PRIMARY REGION "us-east-1";
ALTER DATABASE unsay ADD REGION "us-west-2";
ALTER DATABASE unsay ADD REGION "eu-west-1";
ALTER DATABASE unsay SURVIVE REGION FAILURE;
...
-- versioning in the schema design at the application layer." Unsay does
-- exactly that: the `fact` table below is bitemporal, so point-in-time reconstruction
...
-- ---------------------------------------------------------------------------
ALTER DATABASE unsay CONFIGURE ZONE USING gc.ttlseconds = 90000;
